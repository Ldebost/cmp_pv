		...
		create: function (it) {
			...
			if (typeof cmp_pv.globalVendorList === 'undefined') {
				...
				try {
					...
					css += '	#CMP_PV #step1 .desc{max-height: 356px;overflow: scroll;}';
					css += '}';
